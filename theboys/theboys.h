...
/* As structs abaixo usam "MAX" para definir o tamanho dos vetores. */
/* Redirecionamos para os novos valores "N". */
...
struct evento {
    ...
    int tipo;  /* EV_CHEGA, EV_SAI*/
    int dado1; /* ID do herói ou da missão */
    int dado2; /* ID da base destino */
};
